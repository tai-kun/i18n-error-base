...
export type ErrorOptions = ConstructorParameters<typeof Error> extends [
  message?: unknown,
...
export default class I18nErrorBase<TMeta extends ErrorMeta | undefined = ErrorMeta | undefined>
  extends Error
{
  ...
  public constructor(...params: I18nErrorBaseParams<TMeta>) {
    ...
    const defaultMessage = typeof message === "function"
      ? message(meta)
      : message;
